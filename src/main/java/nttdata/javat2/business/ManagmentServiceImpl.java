...
public class ManagmentServiceImpl implements ManagmentServiceI {
	...
	/**
	 * El método hireEmployee añade un empleado a la base de datos, si la empresa no ha llegado al tope
	 * de empleados permitidos
	 */
	@Override
	public void hireEmployee(String name, String category) {
		...
		if (numberOfEmployees == e.getMAXEMPLOYEES()) {
			...
			System.out.println("La "+e.getId()+" persona ha superado los requisitos y ha sido contratado. Ahora es un empleado.");
			System.out.println();
		}
	...
	/**
	 * El método countAllEmployees cuenta el número total de empleados contratados en la empresa
	 */
	@Override
